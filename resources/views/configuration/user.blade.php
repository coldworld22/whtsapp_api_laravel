...
<form class="lw-ajax-form lw-form" method="post" action="<?= route('manage.configuration.write', ['pageType' => request()->pageType]) ?>">
    ...
    <div class="form-group row">
		...
		<div class="col-sm-12 mb-3 mb-sm-0">
			...
			<textarea rows="10" name="user_terms" class="form-control form-control-user" id="termsAndConditionsUrl"><?= getAppSettings('user_terms') ?></textarea>
    ...
    <div class="form-group row">
		...
		<div class="col-sm-12 mb-3 mb-sm-0">
			...
			<textarea rows="10" name="vendor_terms" class="form-control form-control-user" id="lwVendorTerms"><?= getAppSettings('vendor_terms') ?></textarea>
